...
validate-catalog:
	uv run linkml validate \
		-s src/sp_800_53_catalog/schema/sp_800_53_catalog.yaml \
...
validate-profile:
	uv run linkml validate \
		-s src/sp_800_53_catalog/schema/sp_800_53_profile.yaml \
...
validate-top:
	uv run linkml validate \
		-s src/sp_800_53_catalog/schema/sp_800_53.yaml \
		-C SP80053Document \
		tests/data/nist/NIST_SP-800-53_rev5_LOW-baseline-resolved-profile_catalog.yaml
	uv run linkml validate \
		-s src/sp_800_53_catalog/schema/sp_800_53.yaml \
