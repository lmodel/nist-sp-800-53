...
linkml_meta = LinkMLMeta({'default_prefix': 'nist_sp_800_53',
     ...
     'see_also': ['https://lmodel.github.io/nist-sp-800-53'],
...
class PersonCollection(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/lmodel/nist-sp-800-53', 'tree_root': True})
