...
linkml_meta = LinkMLMeta({'default_prefix': 'sp80053',
     'default_range': 'string',
     'description': 'Unified LinkML schema for OSCAL catalogs and profiles for '
                    'NIST SP 800-53',
     ...
     'subsets': {'nist_sp_800_53_catalog': {'description': 'NIST SP 800-53 Catalog '
                                                           'subset for controls '
                                                           'and assessment '
                                                           'procedures',
                                            'from_schema': 'https://w3id.org/lmodel/nist-sp-800-53r5',
                                            'name': 'nist_sp_800_53_catalog'},
                 'nist_sp_800_53_profile': {'description': 'NIST SP 800-53 Profile '
                                                           'subset for baselines '
                                                           'and overlays',
                                            'from_schema': 'https://w3id.org/lmodel/nist-sp-800-53r5',
                                            'name': 'nist_sp_800_53_profile'}}} )
...
class Catalog(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/lmodel/nist-sp-800-53r5',
         'in_subset': ['nist_sp_800_53_catalog']})
...
class ProfileDocument(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/lmodel/nist-sp-800-53r5',
         'in_subset': ['nist_sp_800_53_profile']})
...
class Role(ConfiguredBaseModel):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'https://w3id.org/lmodel/nist-sp-800-53r5',
         'in_subset': ['nist_sp_800_53_catalog', 'nist_sp_800_53_profile']})
...
class CatalogElement(ConfiguredBaseModel):
    ...
    links: Optional[list[Link]] = Field(default=None, description="""List of links and relationships""", json_schema_extra = { "linkml_meta": {'domain_of': ['Metadata', 'Revision', 'CatalogElement'],
         'in_subset': ['nist_sp_800_53_catalog']} })
    parts: Optional[list[Part]] = Field(default=None, description="""Nested parts that provide prose and structure""", json_schema_extra = { "linkml_meta": {'domain_of': ['CatalogElement'], 'in_subset': ['nist_sp_800_53_catalog']} })
...
class IdentifiedElement(CatalogElement):
    ...
    class_: Optional[CatalogElementClassValue] = Field(default=None, alias="class", description="""Classification of a catalog element or property""", json_schema_extra = { "linkml_meta": {'domain_of': ['IdentifiedElement', 'Property'],
         'in_subset': ['nist_sp_800_53_catalog']} })
    label: Optional[str] = Field(default=None, description="""Human-readable label""", json_schema_extra = { "linkml_meta": {'domain_of': ['IdentifiedElement'], 'in_subset': ['nist_sp_800_53_catalog']} })
    id: Optional[str] = Field(default=None, description="""Unique identifier for an element""", json_schema_extra = { "linkml_meta": {'domain_of': ['Role', 'CatalogElement'],
         'in_subset': ['nist_sp_800_53_catalog', 'nist_sp_800_53_profile']} })
    props: Optional[list[Property]] = Field(default=None, description="""List of properties""", json_schema_extra = { "linkml_meta": {'domain_of': ['Metadata', 'CatalogElement'],
         'in_subset': ['nist_sp_800_53_catalog']} })
...
class Parameter(IdentifiedElement):
    ...
    guidelines: Optional[list[Guideline]] = Field(default=None, description="""List of guidelines""", json_schema_extra = { "linkml_meta": {'domain_of': ['Parameter'], 'in_subset': ['nist_sp_800_53_catalog']} })
    select: Optional[Any] = Field(default=None, description="""Selection parameters for a parameter definition""", json_schema_extra = { "linkml_meta": {'domain_of': ['Parameter'], 'in_subset': ['nist_sp_800_53_catalog']} })
    title: Optional[str] = Field(default=None, description="""Human-readable title""", json_schema_extra = { "linkml_meta": {'domain_of': ['Metadata', 'Revision', 'Role', 'Resource', 'IdentifiedElement'],
         'in_subset': ['nist_sp_800_53_catalog', 'nist_sp_800_53_profile']} })
    class_: Optional[CatalogElementClassValue] = Field(default=None, alias="class", description="""Classification of a catalog element or property""", json_schema_extra = { "linkml_meta": {'domain_of': ['IdentifiedElement', 'Property'],
         'in_subset': ['nist_sp_800_53_catalog']} })
...
class Guideline(ConfiguredBaseModel):
    ...
    prose: Optional[str] = Field(default=None, description="""Free-text prose content""", json_schema_extra = { "linkml_meta": {'domain_of': ['Guideline', 'Part'], 'in_subset': ['nist_sp_800_53_catalog']} })
...
class Property(ConfiguredBaseModel):
    ...
    name: Optional[str] = Field(default=None, description="""Name of a property, part, or party""", json_schema_extra = { "linkml_meta": {'domain_of': ['Party', 'Property', 'Part'],
         'in_subset': ['nist_sp_800_53_catalog', 'nist_sp_800_53_profile']} })
    value: Optional[str] = Field(default=None, description="""Property value""", json_schema_extra = { "linkml_meta": {'domain_of': ['Property'], 'in_subset': ['nist_sp_800_53_catalog']} })
    ns: Optional[str] = Field(default=None, description="""Namespace URI for a property""", json_schema_extra = { "linkml_meta": {'domain_of': ['Property'], 'in_subset': ['nist_sp_800_53_catalog']} })
...
class Link(ConfiguredBaseModel):
    ...
    href: Optional[str] = Field(default=None, description="""Link or resource reference""", json_schema_extra = { "linkml_meta": {'domain_of': ['ResourceLink', 'Link', 'ImportResource'],
         'in_subset': ['nist_sp_800_53_catalog', 'nist_sp_800_53_profile']} })
    rel: Optional[str] = Field(default=None, description="""Relationship type for a link""", json_schema_extra = { "linkml_meta": {'domain_of': ['Link'], 'in_subset': ['nist_sp_800_53_catalog']} })
